...
const Food = (props) => {
    ...
    const fetchData = async () => {
        ...
        console.log("Stored JSON String:", jsonString);

        let userData = JSON.parse(jsonString);
        console.log("Parsed Object:", userData);
        let rest_id;
        ...
        let response = await fetch("http://localhost:3000/api/restaurant/food/" + rest_id);
    ...
    const handleEdit = (_id) => {
        console.log("Editing item with id:", _id);
